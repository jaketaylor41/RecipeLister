...
| <span class="menu-item"><a href="index.php?pageNumber=1">Home</a> </span> | <span class="menu-item"><a href="index.php?pageNumber=2">Add New Recipe</a></span>
    <?php if ($_SESSION['role'] == 'admin'): ?>
    | <span><a href="showAdminPage.php">Admin Page</a></span>
    <?php endif; ?>
</div>
